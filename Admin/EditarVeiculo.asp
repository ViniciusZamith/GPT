    ...
    <form action="<%=Request.ServerVariables("HTTP_REFERER")%>" method="post">
      <div class="form-row">
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" class="form-control"  name="Modelo" value="<%=rsVeiculo("Modelo")%>" required>
        </div>
		<div class="col-md-4 mb-3">
          <label for="validationDefault02">Marca</label>
          <input type="text" class="form-control"  name="Marca" value="<%=rsVeiculo("Marca")%>" required>
        </div>
		<div class="col-md-4 mb-3">
          <label for="validationDefault02">Tipo</label>
          <input type="text" class="form-control"  name="TipoVeiculo" value="<%=rsVeiculo("TipoVeiculo")%>" required>
        </div>
      </div>
      <div class="form-row">
        <div class="col-md-4 mb-3">
          <label for="validationDefault02">Lotação Mínima</label>
          <input type="text" class="form-control" name="LotacaoMin" value="<%=rsVeiculo("LotacaoMin")%>" required>
        </div>
        <div class="col-md-4 mb-3">
